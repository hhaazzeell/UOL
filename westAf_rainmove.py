...
# stash codes for different fields
...
# Extract data from NetC    DF file
  ...
  ilat1=ilat1+int((lat1-lati1)/dlat+0.5) # check this especially pos/neg jumps
  ...
  field_af_1d = field[:,ilat1:ilat2,ilon1:ilon2]
...
#print('cumulative rainfall = ',np.sum(rain1h),' mm')
